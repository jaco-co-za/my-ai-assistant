...
SERVICE_RELATIVE_DIR="micro services/ai-assistant"
...
echo "ai-assistant is starting on http://localhost:${WEBHOOK_PORT:-3350}"
echo "queue UI is starting on http://localhost:8599"
